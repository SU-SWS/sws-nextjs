...
import Link, { LinkProps } from "@/components/Cta/Link";
import { RefObject } from "react";

export const MainMenuClientWrapper = ({
  children,
  ...props
  ...
  return (
    <nav {...props} ref={menuRef}>
      <button
        ...
        aria-label={
          menuOpen ? "Close Main Navigation Menu" : "Open Main Navigation Menu"
        }
      >
...
export const MainMenuItemClientWrapper = ({
  id,
  level,
  link,
  children,
  ...
  useEventListener(
    "keydown",
    handleEscape,
    menuItemRef as unknown as RefObject<HTMLDivElement>,
  );
...
export const MainMenuItemClientLink = ({
  href,
  children,
  ...props
}: LinkProps) => {
