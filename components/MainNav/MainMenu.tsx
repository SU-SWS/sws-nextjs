...
} from "@/components/MainNav/MainMenu.client";
...
type MainMenuProps = {
  ...
  headerLinks?: Array<{ url?: string; title?: string }>;
};
  ...
  return (
    <MainMenuItemClientWrapper
      ...
      className={twMerge(
        ...
        clsx({
          "first:border-t-0 lg:flex lg:border-b-0 last:lg:pr-0": level === 0,
            ...
            className={twMerge(
              ...
              clsx({
                "ml-5 pl-10 aria-current-page:border-digital-red data-intrail:border-transparent lg:ml-0 lg:border-b-[6px] lg:border-l-0 lg:pb-2 lg:pl-0 lg:aria-current-page:border-black lg:data-intrail:border-foggy-dark":
                  level === 0,
                "pl-20 aria-current-page:border-digital-red lg:pl-5 lg:hocus-visible:border-black-true":
                  level === 1,
                "pl-28 aria-current-page:border-digital-red lg:pl-10 lg:hocus-visible:border-black-true":
                  level === 2,
                "pl-48 aria-current-page:border-digital-red lg:pl-20 lg:hocus-visible:border-black-true":
                  level === 3,
                "ml-5 aria-current-page:border-digital-red lg:ml-0 lg:hocus-visible:border-black-true":
                  level !== 0,
              }),
            )}
          >
