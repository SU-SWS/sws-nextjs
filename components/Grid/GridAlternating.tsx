...
type GridAlternatingProps = HTMLAttributes<HTMLElement> &
...
export const GridAlternating = ({
  ...
  return (
    <div
      className={clsx(styles.alternatingGridWrapper, styles.gridWidths[width])}
      ref={containerRef}
    >
      ...
      {addCenterLine && (
        <m.div className={styles.centerline} style={{ scaleY }} />
      )}
    </div>
  );
};
