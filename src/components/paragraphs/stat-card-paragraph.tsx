...
type ColorOption = "2e2d29" | "53565a" | "544948" | "8c1515" | "620059" | "007c92" | "175e54" | "e98300" | "f4f4f4" | "e04f39" | "279989" | "d1660f";
...
const StatCardParagraph = ({
  ...
  const whiteText = bgColor && !["f4f4f4", "e98300", "e04f39"].includes(bgColor);
      ...
      <ReverseVisualOrder>
        {headline && (
          <>
            ...
            {headingLevel === "div" && <div className={twMerge("mb-0", headerClasses)}>{headline}</div>}
          </>
        )}
            ...
            <div className="block">
              <span
                ...
                className={clsx(`fa-${iconName} ${iconStyle} text-[60px]`, {
                  "text-cardinal-red": allowTextColors && iconColor === "8c1515",
                  "text-plum": allowTextColors && iconColor === "620059",
                  "text-lagunita": allowTextColors && iconColor === "007c92",
                  "text-palo-verde-dark": allowTextColors && iconColor === "279989",
          ...
          {statMatches && (
            <CountUpNumber
              ...
              className={clsx("text-[40px] font-bold @xl:text-[50px] @2xl:text-[60px]", {
                "text-cardinal-red": allowTextColors && statColor === "8c1515",
                "text-plum": allowTextColors && statColor === "620059",
                "text-lagunita": allowTextColors && statColor === "007c92",
                "text-palo-verde-dark": allowTextColors && statColor === "279989",
